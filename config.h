...
static const char *fonts[]          = { "Free Sans:style=Bold:size=6" };
static const char dmenufont[]       = "Free Sans:style=Bold:size=6";
...
static const char *dmenucmd[] = { "dmenu_run", "-m", dmenumon, "-fn", dmenufont, "-nb", col_gray1, "-nf", col_gray3, "-sb", col_cyan, "-sf", col_gray4, "-i","-p","Seach:",NULL };
...
static const Key keys[] = {
	...
	{ MODKEY|ShiftMask,             XK_n,      swapwindow,     {0}},
	TAGKEYS(                        XK_1,                      0)
	TAGKEYS(                        XK_2,                      1)
	TAGKEYS(                        XK_3,                      2)
	TAGKEYS(                        XK_4,                      3)
